...
\def\plaintitle{A Comperative Study: Java and Koltin}
...
\title{A Comperative Study : Java and Koltin}
...
\section{Einleitung}
Derzeit werden immer mehr Applikationen mit Kotlin entwickelt.\cite{banerjee2018comparative} Diese Programmiersprache ist im Gegensatz zu
...
\section{Kotlin}
Kotlin ist gleich wie Java eine objektorientierte Programmiersprache. In dieser Sprache geschriebener Code kann 
...
\section{Lesbarkeit}
Viele Entwickler meinen das Kotlin eine bessere Syntax als Java hat und deshalb besser
...
Text zu lesen. Deshalb hat die Wahl der Sprache keinen Einfluss auf die Lesbarkeit, solang
